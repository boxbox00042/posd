...
TEST_F(DrawTest, attachShouldBeCorrectForMutipleObservers)
{
...
TEST_F(DrawTest, notifyShouldBeCorrectForMutipleObservers)
{
    Shape *s1 = new Triangle(*v, *u);
    Shape *s2 = new Rectangle(*k, *l);
    Shape *s3 = new Circle(*r);
...
TEST_F(DrawTest, detachShouldBeCorrectForMutipleObserver)
{
    Shape *s1 = new Triangle(*v, *u);
    Shape *s2 = new Rectangle(*k, *l);
    Shape *s3 = new Circle(*r);
...
TEST_F(DrawTest, AnExceptionShouldBeThrewWhenDetachingNonExistentObserver )
{
    Shape *s1 = new Triangle(*v, *u);
    Shape *s2 = new Rectangle(*k, *l);
    Shape *s3 = new Circle(*r);
...
TEST_F(DrawTest, shapesShouldBeCorrect )
{
    Shape *s1 = new Triangle(*v, *u);
    Shape *s2 = new Rectangle(*k, *l);
    Shape *s3 = new Circle(*r);
